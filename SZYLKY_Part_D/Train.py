...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--threshold-override", type=float, default=GROUP["train_threshold_override"], help="Manually set the final classification threshold")
    parser.add_argument(
        "--threshold-metric",
        choices=sorted(SUPPORTED_THRESHOLD_METRICS),
        default=GROUP["balanced_metric_name"],
        help="OOF metric used to choose the final classification threshold",
    )
