...
def build_temporal_outputs(
    ...
    with log_stage(f"构建时序关系图 {split}"):
        ...
        relation_graph = _predict_next_adjacency(
            providers,
            emb_np,
            business,
        ...
        rel_edges = relation_graph.reset_index(names="Provider_src").melt(id_vars="Provider_src", var_name="Provider_dst", value_name="weight")
        rel_edges = rel_edges[rel_edges["weight"] > 0].copy()
